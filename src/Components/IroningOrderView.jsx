...
import { ironingOrderListState, orderStatus } from "../state/state";
import { useRecoilState } from "recoil";
import { useState } from "react";
import { FaRegCircle } from "react-icons/fa";
import { MdCurrencyRupee } from "react-icons/md";

const IroningOrderView = () => {
  ...
  return (
    <div>
      {console.log(ironingOrderList)}
      {ironingOrderList.map((item, index) => (
        <div className="p-2">
          <button
          ...
          >
            <div className="">
              <div className="flex m-2 gap-2 items-center justify-start text-[10px]">
                {item.press_services.map((orderItem) => (
...
export default IroningOrderView;
