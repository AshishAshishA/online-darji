...
import { cleaningOrderListState, orderStatus } from "../state/state";
import { useRecoilState } from "recoil";
import { useState } from "react";
import { FaRegCircle } from "react-icons/fa";
import { MdCurrencyRupee } from "react-icons/md";

const CleaningOrderView = () => {
  ...
  return (
    <div>
      {console.log(cleaningOrderList)}
      {cleaningOrderList.map((item, index) => (
        <div className="p-2">
          <button
          ...
          >
            <div className="">
              <div className="flex m-2 gap-2 items-center justify-start text-[10px]">
                {item.cleaning_services.map((orderItem) => (
                  <div className="flex flex-col items-center justify-center">
                    <p>garment: {orderItem.garment_name}</p>
                    <p>
                      Service: <span>{orderItem.service}</span>
                    </p>
...
export default CleaningOrderView;
